    ...
    'import/no-restricted-paths': [
      'error',
      {
        zones: [
          ...
          // `./src/feature-flags`, `./src/components/modal`, `./src/k8s/error.ts`, `./src/shared/utils`, `./src/analytics`, `src/routes` or `src/monitoring`.
          {
            target: './src/feature-flags/**/*',
            from: [
              './src/!(feature-flags|components|k8s|shared|analytics|routes|monitoring)/**/*',
