...
import { filterOutStaleRunningPipelineRunsFromArchive } from './resource-utils';
...
const getFilteredPipelineRuns = async (
  ...
  const filteredPipelineRuns = filterOutStaleRunningPipelineRunsFromArchive(
    originalPipelineRuns,
  ) as PipelineRunKindV1Beta1[];
