...
import {
  useIntegrationTestScenarioByComponentGroup,
  useIntegrationTestScenariosByComponentGroup,
} from '../useIntegrationTestScenariosByComponentGroup';
...
describe('useIntegrationTestScenarioByComponentGroup', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it('should return the scenario when the group matches', () => {
    const { result } = renderHook(() =>
      useIntegrationTestScenarioByComponentGroup('test-ns', 'group-1', 'test-a'),
    );
  ...
  it('should return a 404 when the scenario belongs to a different group', () => {
    const { result } = renderHook(() =>
      useIntegrationTestScenarioByComponentGroup('test-ns', 'group-2', 'test-a'),
    );
  ...
  it('should watch the named scenario in the given namespace', () => {
    renderHook(() => useIntegrationTestScenarioByComponentGroup('test-ns', 'group-1', 'test-a'));
