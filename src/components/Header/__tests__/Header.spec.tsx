...
describe('Header Integration Tests', () => {
  ...
  describe('Component Integration', () => {
    ...
    it('should render components in correct order', () => {
      ...
      // Check that all required components are present (not checking exact order as it may vary)
      const testIds = Array.from(toolbarItems || []).map((item) =>
        item.getAttribute('data-testid'),
      );

      expect(testIds).toContain('theme-dropdown');
      expect(testIds).toContain('user-dropdown');
      expect(testIds).toContain('help-dropdown-toggle');
