...
describe('ConformaResultsToolbar', () => {
  ...
  it('renders the show duplicates help tooltip trigger as keyboard-focusable with an accessible name', () => {
    renderToolbar();

    const tooltipTrigger = screen.getByLabelText(/multi-arch builds/i);
