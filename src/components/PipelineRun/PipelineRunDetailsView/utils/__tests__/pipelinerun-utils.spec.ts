  ...
  describe('getSourceUrl', () => {
    it('should return URL from PAC annotation when available', () => {
      const pipelineRun = {
        metadata: {
          annotations: {
            [PipelineRunLabel.COMMIT_FULL_REPO_URL_ANNOTATION]: 'https://github.com/user/repo?param=value',
          },
        },
    ...
    it('should return URL from BuildService annotation when PAC annotation is not available', () => {
      const pipelineRun = {
        metadata: {
          annotations: {
            [PipelineRunLabel.BUILD_SERVICE_REPO_ANNOTATION]: 'https://gitlab.com/user/repo?param=value',
          },
        },
      } as unknown as PipelineRunKind;
    ...
    it('should strip query parameters from the returned URL', () => {
      const pipelineRun = {
        metadata: {
          annotations: {
            [PipelineRunLabel.COMMIT_FULL_REPO_URL_ANNOTATION]: 'https://github.com/user/repo?foo=bar&baz=qux',
          },
        },
      } as unknown as PipelineRunKind;
