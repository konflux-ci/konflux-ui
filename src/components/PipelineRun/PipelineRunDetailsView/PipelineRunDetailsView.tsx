...
import { usePipelineRunStatusOnFavicon } from '~/hooks/usePipelineRunStatusOnFavicon';
...
export const PipelineRunDetailsView: React.FC = () => {
  ...
  const faviconStatus = React.useMemo(
    () => (pipelineRun ? pipelineRunStatus(pipelineRun) : runStatus.Unknown),
    [pipelineRun],
  );
  usePipelineRunStatusOnFavicon(faviconStatus);
