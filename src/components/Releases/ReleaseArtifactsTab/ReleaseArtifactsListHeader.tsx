...
export const releaseArtifactsTableColumnClasses = {
  componentName: 'pf-m-width-20',
  url: 'pf-m-width-45 wrap-column',
  arches: 'pf-m-width-30',
};
...
const releaseArtifactsColumns = [
  ...
  { title: 'URL', className: releaseArtifactsTableColumnClasses.url, sortable: true },
  { title: 'Arches', className: releaseArtifactsTableColumnClasses.arches, sortable: true },
];
