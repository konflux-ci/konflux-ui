...
export const releasesTableColumnClasses = {
  ...
  managedCollectorPipelineRun: 'pf-m-hidden    pf-m-width-10-on-xl pf-m-visible-on-xl',
...
const releaseColumns = [
  ...
  { title: 'Managed Collector', className: releasesTableColumnClasses.managedCollectorPipelineRun },
