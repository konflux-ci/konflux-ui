...
describe('EditParamsModal', () => {
  ...
  it('should trim whitespace from param values when saving', async () => {
    patchResourceMock.mockResolvedValue({});
    const onClose = jest.fn();
    formikRenderer(
      <EditParamsModal intTest={MockIntegrationTestsWithParams[1]} onClose={onClose} />,
    ...
    const valueInput = await screen.findByTestId('param-1-value-0');
  ...
  it('should trim whitespace from param names when saving', async () => {
    patchResourceMock.mockResolvedValue({});
    const onClose = jest.fn();
    formikRenderer(
      <EditParamsModal intTest={MockIntegrationTestsWithParams[1]} onClose={onClose} />,
