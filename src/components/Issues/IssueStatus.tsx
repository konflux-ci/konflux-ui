...
export const LockedIcon: React.FC = () => <LockIcon title="Restricted" color={redColor.value} />;

export const UnlockedIcon: React.FC = () => <LockOpenIcon title="Open" color={greenColor.value} />;
...
export const IssueStatus: React.FC<React.PropsWithChildren<IssueStatusProps>> = ({
  locked,
  condensed,
}) => (
