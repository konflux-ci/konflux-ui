...
import { ApplicationFilter } from '../Filter/generic/ApplicationFilter';
import { SearchFilter } from '../Filter/generic/SearchFilter';
import { StatusFilter } from '../Filter/generic/StatusFilter';
import { TenantFilter } from '../Filter/generic/TenantFilter';
...
export const ReleaseFilters: React.FC<ReleaseFiltersProps> = ({
  ...
  const [activeAttributeMenu, setActiveAttributeMenu] = React.useState<
    'Application' | 'Namespace' | 'Release Plan' | 'Status'
  >('Application');
    ...
    <Menu
      ...
      onSelect={(_ev, itemId) => {
        setActiveAttributeMenu(
          itemId?.toString() as 'Application' | 'Namespace' | 'Release Plan' | 'Status',
        );
        setIsAttributeMenuOpen(!isAttributeMenuOpen);
      }}
    >
