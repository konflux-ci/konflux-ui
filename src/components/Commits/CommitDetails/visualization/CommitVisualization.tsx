...
import { scrollNodeIntoView } from '../../../PipelineRun/PipelineRunDetailsView/visualization/utils/pipelinerun-graph-utils';
...
const CommitVisualization: React.FC<{ commit: Commit }> = ({ commit }) => {
