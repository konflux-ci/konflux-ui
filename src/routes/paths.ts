...
export const GROUP_INTEGRATION_TEST_ADD_PATH = GROUP_INTEGRATION_TEST_LIST_PATH.extend('add');

export const GROUP_INTEGRATION_TEST_EDIT_PATH = GROUP_INTEGRATION_TEST_DETAILS_PATH.extend('edit');
