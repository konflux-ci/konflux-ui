...
describe('Basic Happy Path', () => {
  ...
  describe('Check Page Header', () => {
    ...
    it('Check Help Menu', () => {
      HelpMenu.clickHelpMenuToggle();
      HelpMenu.verifyMenuItems();
      HelpMenu.verifyDocumentationLink('https://konflux-ci.dev/docs/');
      HelpMenu.closeHelpMenu();
    });
  });
