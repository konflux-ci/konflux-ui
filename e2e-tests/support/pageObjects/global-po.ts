...
export const alert = '.pf-v6-c-alert';
export const alertTitle = '.pf-v6-c-alert__title';
...
export const waits = {
  ...
  linkPlaceholder: '.pf-v6-c-skeleton',
};
...
export const breadcrumb = {
  breadcrumbLink: 'nav[data-ouia-component-type="PF6/Breadcrumb"]',
};
...
export const UIhelperPO = {
  ...
  tabs: 'div[data-ouia-component-type="PF6/Tabs"] button span',
  formGroup: 'div.pf-v6-c-form__group',
  formGroupLabelText: 'div.pf-v6-c-form__group span.pf-v6-c-form__label-text',
  listGroup_dt: 'div[class*="list__group"] dt',
  pf6_button: '[data-ouia-component-type="PF6/Button"]',
  tableRow: (tableAriaLabel: string) => `[aria-label="${tableAriaLabel}"] tr[role="row"]`,
  dropdownToggle: 'button[data-ouia-component-type="PF6/DropdownToggle"]',
};
