...
if [[ $REMOTE_URL == *"github.com"* ]]; then
    ...
    apply_git_config "$HOME/.gitconfig-github"
    apply_git_config "$HOME/.config/git/github"
elif [[ $REMOTE_URL == *"gitlab.com"* ]]; then
    echo "🦊 GitLab repository detected"  
    apply_git_config "$HOME/.gitconfig-gitlab"
    apply_git_config "$HOME/.config/git/gitlab"
elif [[ $REMOTE_URL == *"bitbucket.org"* ]]; then
    echo "🪣 Bitbucket repository detected"
    apply_git_config "$HOME/.gitconfig-bitbucket"
    apply_git_config "$HOME/.config/git/bitbucket"
else
    ...
    apply_git_config "$HOME/.gitconfig-$HOSTNAME"
    apply_git_config "$HOME/.config/git/$HOSTNAME"
fi
